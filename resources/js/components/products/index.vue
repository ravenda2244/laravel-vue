        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(product, key) of products" v-bind:key="product">
                            <td>{{ key+1 }}</td>
                            <td>{{ product.name }}</td>
...
<script>
    export default {
        ...
        methods: {
            getProducts() {
              this.axios.get('http://146.56.115.215/api/products').then(response => {
            ...
            deleteProduct(productId) {
                this.axios
                    .delete(`http://146.56.115.215/api/products/${productId}`)
                    .then(response => {
